...
kbl(booktabs = T, col.names = c("Variant", "Comparison", "Performance", "Uplift (%)","Performance", "Uplift (%)"), 
  ...
  footnote(general = "Uplift is calculated for the variant relative to the control. A negative value means the variant performed worse than the control.")
...
get_summary_values(var_totals_editorial_new_trending, hids_visits_summary)%>%
  kbl(booktabs = T, 
      col.names = c('Age Range', "Variant", "Users", "Visits", "Rail Clicks", "Starts", "Completes"),
      caption = paste0(rail_name,": ",age_range),
    escape = F) %>%
  kable_styling(latex_options =c("striped", "scale_down"))
